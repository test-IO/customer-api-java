...
public final class TestEnvironmentExample {
  ...
  public static final TestEnvironment TEST_ENVIRONMENT =
  ...
  public static final TestEnvironmentResponse TEST_ENVIRONMENT_RESPONSE =
      TestEnvironmentResponse.builder().testEnvironment(TEST_ENVIRONMENT).build();

  public static final TestEnvironmentsResponse TEST_ENVIRONMENTS_RESPONSE =
      TestEnvironmentsResponse.builder()
          .testEnvironments(Collections.singletonList(TEST_ENVIRONMENT))
          .build();

  public static final TestEnvironmentRequest TEST_ENVIRONMENT_REQUEST =
      TestEnvironmentRequest.builder()
          .title("White Inc")
          .url("http://will.co/keith")
          .username("terrell_zieme")
          .password("DxFx8S56zNcTuEt")
