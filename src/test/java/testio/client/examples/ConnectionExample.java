...
public final class ConnectionExample {
  ...
  public static final ConnectionResponse CONNECTION_RESPONSE =
      ConnectionResponse.builder().connection(CONNECTION).build();

  public static final CreateConnectionRequest CREATE_CONNECTION_REQUEST =
  ...
  public static final UpdateConnectionRequest UPDATE_CONNECTION_REQUEST =
