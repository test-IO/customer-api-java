...
public final class TestCaseExample {
    ...
    public static final TestCasesResponse TEST_CASES_RESPONSE = TestCasesResponse.builder()
    ...
    public static final TestCasesRequest BULK_TEST_CASE_REQUEST = TestCasesRequest.builder()
            .testCaseRequests(Collections.singletonList(TestCaseRequest.builder()
                    .title("New test case")
                    .featureId(1L)
                    .steps(Collections.singletonList(
                            TestCaseStep.builder()
