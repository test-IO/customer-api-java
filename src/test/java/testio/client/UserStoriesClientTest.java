...
public class UserStoriesClientTest {
    ...
    void verifyListUserStories() throws Exception {
        server.enqueue(new MockResponse().setBody(OkioUtil.resourceToString("/userStoriesResponse.json")));
        ...
        assertThat(recordedRequest.getRequestLine()).isEqualTo("GET /v2/customer/products/1/user_stories HTTP/1.1");
        assertThat(recordedRequest.getHeader("Authorization")).isEqualTo("Token abc");
    }

    @Test
    void verifyCreateUserStory() throws Exception {
        server.enqueue(new MockResponse().setBody(OkioUtil.resourceToString("/userStoryResponse.json")));

        UserStoryResponse response = userStoriesClient
        ...
        RecordedRequest recordedRequest = server.takeRequest();
        assertThat(recordedRequest.getRequestLine()).isEqualTo("POST /v2/customer/products/1/user_stories HTTP/1.1");
        assertThat(recordedRequest.getHeader("Authorization")).isEqualTo("Token abc");
    }
    ...
    void verifyDeleteUserStory() throws Exception {
        ...
        RecordedRequest recordedRequest = server.takeRequest();
        assertThat(recordedRequest.getRequestLine()).isEqualTo("DELETE /v2/customer/products/1/user_stories/1 HTTP/1.1");
        assertThat(recordedRequest.getHeader("Authorization")).isEqualTo("Token abc");
    }
    ...
    void verifyUpdateUserStory() throws Exception {
        ...
        RecordedRequest recordedRequest = server.takeRequest();
        assertThat(recordedRequest.getRequestLine()).isEqualTo("PUT /v2/customer/products/1/user_stories/1 HTTP/1.1");
        assertThat(recordedRequest.getHeader("Authorization")).isEqualTo("Token abc");
    }
}
