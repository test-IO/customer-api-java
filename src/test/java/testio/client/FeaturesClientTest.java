...
public class FeaturesClientTest {
    ...
    void verifyListFeatures() throws Exception {
        ...
        assertThat(recordedRequest.getRequestLine()).isEqualTo("GET /v2/customer/products/1/features HTTP/1.1");
    ...
    void verifyCreateFeature() throws Exception {
        ...
        FeatureResponse response = featuresClient
                .createFeature(1L, CREATE_FEATURE_REQUEST.buildRequest())
                .execute()
                .body();
        ...
        RecordedRequest recordedRequest = server.takeRequest();
        assertThat(recordedRequest.getRequestLine()).isEqualTo("POST /v2/customer/products/1/features HTTP/1.1");
        assertThat(recordedRequest.getHeader("Authorization")).isEqualTo("Token abc");
    }
}
