...
public interface TestEnvironmentsClient {
    ...
    Call<TestEnvironmentResponse> createTestEnvironment(
            ...
            @Body TestEnvironmentRequest.RequestWrapper request
    );
    ...
    Call<TestEnvironmentResponse> deleteTestEnvironment(@Path("product_id") Long productId, @Path("test_environment_id") Long id);
}
